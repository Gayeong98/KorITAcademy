...
// 1. 접근 제어자
//	  public, protected, default(package), private가 있음
// 2. 일반 제어자
...
public abstract class Example02 {
	...
	// protected 접근제어자
	// 같은 패키지 내에 있고 해당 클래스를 상속받은 자식 클래스에서만 접근이 가능
